...
**Cable Options** (separate purchase):

- Retro Cable Pack: Adds N64, SNES, and NES compatibility
...
- Switch sets (Gateron and MX-compatible options)
- Keycap sets
- LED diffusers and accessories
