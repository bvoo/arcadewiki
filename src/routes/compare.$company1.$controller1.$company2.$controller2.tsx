...
function ComparisonPage() {
	...
	const [bookmarked1, setBookmarked1] = React.useState(() =>
		isBookmarked(company1, controller1),
	);
	const [bookmarked2, setBookmarked2] = React.useState(() =>
		isBookmarked(company2, controller2),
	);
