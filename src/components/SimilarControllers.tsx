    ...
    <div className="mt-12 pt-8 border-t border-border">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {controllers.map(({ doc, reasons }) => {
          ...
          const buttonLabel = buttonType ? buttonType.charAt(0).toUpperCase() + buttonType.slice(1) : ''
          const buttonVariant = buttonType === 'digital' ? 'default' : 'secondary'
                ...
                <CardHeader className="pb-2">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">{meta.maker}</p>
                    </div>
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent side="top" className="max-w-[200px] bg-background text-foreground border-1">
                ...
                <CardContent className="space-y-2">
                  <div className="flex items-center justify-between gap-2">
                    <div className="flex gap-2">
                      {buttonLabel && (
                        <Badge variant={buttonVariant as any} className="font-mono text-xs">
                          {buttonLabel}
                        </Badge>
                      )}
                      {meta.currentlySold && (
                    ...
                    {meta.weightGrams && (
                      <p className="text-muted-foreground text-xs font-mono">{meta.weightGrams}g</p>
                    )}
                  </div>
